...
$config = array(
	...
	*/
	...
	"mirror" => "cpabuild.com",
	/*
	 * View a list of mirrors here: https://members.cpabuild.com/mirrors
	 * Example mirror: bitsc.io
	 * Using a mirror can prevent Google from de-indexing websites for using CPABuild
	 */
    ...
    /*
	 * Protocol used to get html from cpabuild servers
	 */
);
